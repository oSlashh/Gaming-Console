...
@Component({
  selector: 'app-puzzle-realm',
  standalone: true,
  template: `
    <div class="realm-container">
      <div class="realm-left">
        <h1 class="realm-title">Puzzle Realm</h1>
        <p class="realm-desc">
          Reconstruct broken fragments to unlock ancient memories. Piece together the shards of the past to rebuild the artwork.
        </p>
...
export class PuzzleRealmComponent {}
